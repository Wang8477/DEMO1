...
void setup_scr_screen_1(lv_ui *ui)
{
	...
	lv_obj_set_pos(ui->screen_1_cont_1, 0, 20);
	lv_obj_set_size(ui->screen_1_cont_1, 240, 200);
	...
	lv_obj_set_pos(ui->screen_1_label_1, 66, 88);
	...
	lv_span_set_text(screen_1_spangroup_1_span, "hello");
	...
	lv_style_set_text_font(&screen_1_spangroup_1_span->style, &lv_font_montserratMedium_12);
	lv_obj_set_pos(ui->screen_1_spangroup_1, 20, 58);
	lv_obj_set_size(ui->screen_1_spangroup_1, 200, 100);
	...
	lv_label_set_text(ui->screen_1_btn_1_label, "select");
	...
	lv_label_set_text(ui->screen_1_btn_2_label, "set");
