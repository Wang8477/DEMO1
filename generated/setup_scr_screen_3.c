...
void setup_scr_screen_3(lv_ui *ui)
{
	...
	ui->screen_3_list_1_item0 = lv_list_add_btn(ui->screen_3_list_1, LV_SYMBOL_EDIT, "wangrui");
	ui->screen_3_list_1_item1 = lv_list_add_btn(ui->screen_3_list_1, LV_SYMBOL_CALL, "18230108477");
	ui->screen_3_list_1_item2 = lv_list_add_btn(ui->screen_3_list_1, LV_SYMBOL_WIFI, "Mr.Wang");
	lv_obj_set_pos(ui->screen_3_list_1, 39, 53);
	lv_obj_set_size(ui->screen_3_list_1, 160, 100);
	...
	lv_style_set_pad_top(&style_screen_3_list_1_main_main_default, 5);
	lv_style_set_pad_left(&style_screen_3_list_1_main_main_default, 5);
	lv_style_set_pad_right(&style_screen_3_list_1_main_main_default, 5);
	lv_style_set_pad_bottom(&style_screen_3_list_1_main_main_default, 5);
	lv_style_set_bg_opa(&style_screen_3_list_1_main_main_default, 255);
	lv_style_set_bg_color(&style_screen_3_list_1_main_main_default, lv_color_hex(0xffffff));
	lv_style_set_bg_grad_dir(&style_screen_3_list_1_main_main_default, LV_GRAD_DIR_NONE);
	...
	lv_style_set_border_color(&style_screen_3_list_1_main_main_default, lv_color_hex(0xe1e6ee));
	lv_style_set_border_side(&style_screen_3_list_1_main_main_default, LV_BORDER_SIDE_FULL);
	lv_style_set_radius(&style_screen_3_list_1_main_main_default, 3);
	lv_style_set_shadow_width(&style_screen_3_list_1_main_main_default, 0);
