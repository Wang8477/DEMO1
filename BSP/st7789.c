...
void ST7789_Init(void)
{
    ...
    ST7789_WriteSmallData(0x32);            //Vcom=1.35V
	...
	ST7789_WriteSmallData (0x15);	        //GVDD=4.8V  ÑÕÉ«Éî¶È
...
#ifdef USE_DMA
    memset_16((uint16_t*)disp_buf, color, sizeof(disp_buf) / 2); // §²§Ñ§Ù§Þ§Ö§â §Ó §ï§Ý§Ö§Þ§Ö§ß§ä§Ñ§ç
    SendBuffer((uint16_t*)disp_buf, sizeof(disp_buf) / 2);      // §²§Ñ§Ù§Þ§Ö§â §Ó 16-§Ò§Ú§ä§ß§í§ç §ã§Ý§à§Ó§Ñ§ç
#else
